docker build oakkas/multi-client:latest -t oakkas/multi-client:$SHA -f ./client/Dockerfile ./client
docker build oakkas/multi-server:latest -t oakkas/multi-server:$SHA -f ./server/Dockerfile ./server
docker build oakkas/multi-worker:latest -t oakkas/multi-worker:$SHA -f ./worker/Dockerfile ./worker
